...
// const text = `Monitor Your Basic Information: Provide your name, email address, and a password for your AWS account.`
const text = `The AWS Management Console is a browser-based interface for managing AWS services. It offers an organized view of your resources, configuration options, and account settings. Key features include:\n\n* **Dashboard:** Upon login, the dashboard summarizes your account, including running services and links to frequently used services.\n\n* **Service Selection:** Access all AWS services like EC2, S3, RDS, Lambda, etc., from the **It includes** menu.\n\n* **Resource Groups:** Group resources by project, region, or other criteria for streamlined management.\n\n* **Search Bar:** Quickly find specific resources, services, or documentation.\n\n* **Account Settings:** Access security credentials, billing, and other account settings from the drop-down menu under your account name.`;

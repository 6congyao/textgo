    ...
    api: function (View) {
        View.prototype.replaceWithSynonyms = function (nounsDict, adjsDict, verbsDict, adverbsDict) {
            ...
            if (verbsDict) {
                ...
                m2.map(v => {
                    console.log(v.text());
                    if (v.match('(@hasComma|@hasQuote|@hasPeriod|@hasExclamation|@hasQuestionMark|@hasEllipses|@hasSemicolon|@hasColon|@hasContraction)').found) {
                        return v;
                    }
...
const text = `Digital archives, online databases, and virtual museums have made historical documents and artifacts more accessible to a global audience. This democratization of historical knowledge has profound implications for education, research, and cultural preservation.
Digital archives, such as the Library of Congress and the British Library, provide online access to vast collections of historical documents, manuscripts, and photographs. Researchers, students, and the general public can explore these digital repositories, gaining insights into historical events and cultural heritage.`;

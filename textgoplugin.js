...
const text = `As air is going to walk away into the purifier, it passes through the filter, trapping fine particles such as dust, smoke, pollen, and pet dander. Some purifiers incorporate additional filters, like activated carbon filters, to eliminate odors and volatile organic compounds (VOCs).`;
